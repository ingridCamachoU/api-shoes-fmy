...
CREATE TABLE public.sizes (
	...
	updated_at timestamptz NOT NULL,
	deleted_at timestamptz NULL,
	CONSTRAINT sizes_number_key UNIQUE ("number"),
...
CREATE TABLE public.sizes_products (
	...
	product_id int8 NOT NULL,
    CONSTRAINT sizes_products_pkey PRIMARY KEY (id)
);
CREATE INDEX sizes_products_size_id_7392030e ON public.sizes_products USING btree (size_id);
CREATE INDEX sizes_products_product_id_90f4ac8b ON public.sizes_products USING btree (product_id);

ALTER TABLE public.sizes_products ADD CONSTRAINT sizes_products_size_id_7392030e_fk_size_id FOREIGN KEY (size_id) REFERENCES public.sizes(id) DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE public.sizes_products ADD CONSTRAINT sizes_products_product_id_90f4ac8b_fk_product_id FOREIGN KEY (product_id) REFERENCES public.products(id) DEFERRABLE INITIALLY DEFERRED;
